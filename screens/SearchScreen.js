...
const SearchScreen = () => {
  ...
  const data = [
    {
      ...
      shortDescription: "City in Moscow, Russia",
      properties: [
        {
          id: "10",
          name: "FabHotel Zeke",
          ...
          rating: 3.6,
          address:
            "346, Hennur Main Road, Post, Kalyan Nagar, 560043 Moscow, Russia ",
          oldPrice: 4600,
          newPrice: 3312,
          latitude: "33.0359",
          longitude: "47.6431",
        ...
        },
        {
          ...
          name: "Regenta Inn  Moscow",
          rating: 4,
          address:
            " 648/B, Regenta Inn, 1st stage Indiranagar, 560038 Moscow, Russia",
          oldPrice: 4201,
          newPrice: 3327,
          latitude: "32.9784",
          longitude: "47.6408",
        ...
        {
          id: "12",
          name: "Bloom Hotel - Sheremetievo Airport",
          rating: 4.2,
          address:
            "Down Town Park, Sheremetievo Airport , 562157 Moscow, Russia",
          oldPrice: 3800,
          newPrice: 3078,
          latitude: "13.1989",
          longitude: "77.7068",
      ...
      properties: [
        {
          ...
          rating: 3.5,
          address:
            "CFC-4/C, Road No-2 Hardware Park, Beside TCS, 501351 Hyderabad, Russia",
          oldPrice: 4332,
          newPrice: 3200,
          photos: [
            {
        ...
        },
        {
          ...
          rating: 4.5,
          address:
            "Plot 73, Shilpi Valley, Opp Hitech City Mindspace, Moscow",
          oldPrice: 5200,
          newPrice: 4100,
          photos: [
            {
  ...
  return (
    <SafeAreaView >
      <View 
        style={{
          padding:10,margin:10, flexDirection:"row",alignItems:"center",justifyContent:"space-between",borderColor:"#ffc72c",
          borderWidth:4,
          borderRadius:18
        }}
      >
